...
public class AnforandeListaDtoTest {
    ...
    void canDeserializeJson() throws IOException {
        AnforandeListaDto anforandeListaDto = new ObjectMapper().readValue(json, AnforandeListaDto.class);

        Assertions.assertEquals(anforandeListaDto.getAnforande().size(), 1);
    }
}
